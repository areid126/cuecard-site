...
// Set up cors differently depending on whether it is deployed
const CORS_ACCESS = process.env.NODE_ENV === "production" ? { credentials: true, origin: process.env.FRONTEND_URL } : undefined;
// Pass cookies differently depending on whether it is deployed
